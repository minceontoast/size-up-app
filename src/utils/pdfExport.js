...
export async function generatePDF({ selections, selectionLabels = {}, comments = {}, operationName, assessorName, date }) {
  ...
  doc.text(`Generated by Size Up App ${VERSION} - ${date}`, pageWidth / 2, footerY, { align: 'center' });
  doc.text('Based on Event Appreciation Activation Guide by TOA Consulting NZ, app created by Ed Cook', pageWidth / 2, footerY + 4, {
    align: 'center',
  });
